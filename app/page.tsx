  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center p-4 text-black">
      <main className="p-8 max-w-5xl w-full">
        ...
        >
          VQuiz is an AI-powered quiz platform that helps you learn and test your knowledge.
        </motion.p>
